...
if __name__ == "__main__":
    ...
    onnx_model_path = 'models/model.onnx'   # Change this to your desired model

    # Specify the output path for the quantized model
    quantized_model_path = 'models/model_int8.onnx'  # Change this to your desired output file name
